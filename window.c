...
{  100, animation_objet, NULL, NULL}, //
{15000, animation_city, NULL, NULL}, //
{11000, animation_voiture, animation_flash, transition_fondu},
{ 1000, animation_vide,NULL,NULL},
{34000, animation_battleship,NULL, NULL},
{ 3500, animation_battleship,animation_vide,transition_fondu},
{ 2000, animation_vide,NULL,NULL},
{39000, animation_superhot,NULL,NULL},
...
int main(int argc, char ** argv) {
  if(!gl4duwCreateWindow(argc, argv, "GL4D API8 HOBEAN BAE", 
