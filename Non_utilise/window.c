...
static GL4DHanime _animations[] = { 
 ...
 //{ 8200, animation_tron,NULL,NULL},
// { 2000,animation_tron,animation_opening, transition_fondu},
 //{12000, animation_soleil,NULL, NULL },
 //{5000, animation_base,animation_vide,transition_fondu},
//{15000,animation_spiral, NULL, NULL}, 
//{10000, animation_objet, NULL, NULL}, // animation complete
//{ 1000, animation_vide,NULL, NULL },// 
 //{11000, animation_voiture, animation_flash, transition_fondu},// animation voiture
  //{13000, animation_ending,NULL,NULL},//
 //{  5000, animation_graph,NULL, NULL },// 
{60000, animation_objet, NULL, NULL}, // animation complete
 {  100, animation_vide,NULL, NULL },// 
...
//static GLfloat _dim[] = {1280,1000}; //full screen
...
int   _windowHeight; 
  ...
  gl4duLoadIdentityf();
  gl4duFrustumf(-0.5, 0.5, -0.5 * _windowHeight / _windowWidth, 0.5 * _windowHeight / _windowWidth, 1.0, 1000);
}
*/
